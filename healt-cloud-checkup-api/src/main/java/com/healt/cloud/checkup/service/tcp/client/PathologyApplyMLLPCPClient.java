...
import com.healt.cloud.checkup.service.tcp.vo.pathology.PathologyApplyVo;
...
/**
 * @author linklee
 * @create 2022-07-27 15:59
 */
@Service
public class PathologyApplyMLLPCPClient {
    ...
    public boolean sendPathologyApply(PathologyApplyVo pathologyApplyVo){
        ...
        try{
            ...
            testHL7MessageToTransmit.append(START_OF_BLOCK)
                    ...
                    .append(pathologyApplyVo.toString())
                    .append(END_OF_BLOCK)
                    .append(CARRIAGE_RETURN);
