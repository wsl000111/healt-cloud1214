...
/**
 * <p>notPayDetailQueryResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="notPayDetailQueryResponse"&gt;
 *   &lt;complexContent&gt;
 ...
 *                 &lt;sequence&gt;
 *                   &lt;element name="ChargeItem" type="{http://wegohis.com}notPayDetailQuery" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "notPayDetailQueryResponse", propOrder = {
    "patientInfo",
    "chargeItemList"
})
public class NotPayDetailQueryResponse
    extends SoapBaseResponse
{
    ...
    public static class ChargeItemList {
        ...
        protected List<NotPayDetailQuery> chargeItem;
         ...
         * {@link NotPayDetailQuery }
         * 
         * 
         */
        public List<NotPayDetailQuery> getChargeItem() {
            if (chargeItem == null) {
                chargeItem = new ArrayList<NotPayDetailQuery>();
            }
