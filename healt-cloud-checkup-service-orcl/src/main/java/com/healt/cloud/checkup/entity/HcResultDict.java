...
@TableName("HC_RESULT_DICT")
@ApiModel(value="HcResultDict对象", description="体检项目结果记录")
public class HcResultDict implements Serializable {
    ...
    @ApiModelProperty(value = "异常标志  由于ABNORMAL_INDICATOR用的比较杂")
